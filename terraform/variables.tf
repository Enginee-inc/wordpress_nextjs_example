...
variable "wordpress_container_linux_fx_version" {
  ...
  default     = "appsvc/wordpress-debian-php:8.3"
}
...
variable "static_web_app_repository_url" {
  description = "Static Web App Repository URL"
}

variable "static_web_app_repository_branch" {
  description = "Static Web App Repository Branch"
  default     = "main"
}

variable "static_web_app_repository_token" {
